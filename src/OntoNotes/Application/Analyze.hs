...
module OntoNotes.Application.Analyze where
...
queryProcess pp sensemap sensestat framedb ontomap input = do
...
runAnalysis input pp = do
  ...
  queryProcess pp sensemap sensestat framedb ontomap input
