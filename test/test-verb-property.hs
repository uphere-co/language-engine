...
ex2 = ( "He will be fined $25,000.", (Present,Simple,Passive, Just "will",Nothing)
...
ex3 = ( "He has been fined $25,000.", (Present,Perfect,Passive,Nothing,Nothing)
...
ex4 = ( "The move had been widely expected.", (Past,Perfect,Passive,Nothing,Nothing)
...
ex5 = ( "I am floating.", (Present,Progressive,Active,Nothing,Nothing)
...
ex6 = ( "I am studying with Maria.", (Present,Progressive,Active,Nothing,Nothing)
...
ex7 = ( "We eat lunch.", (Present,Simple,Active,Nothing,Nothing)
...
ex8 = ( "We are eating lunch.", (Present,Progressive,Active,Nothing,Nothing)
...
ex9 = ( "We are not eating lunch right now.", (Present,Progressive,Active,Nothing,Just "not")
...
ex10 = ( "It's not done yet.", (Present,Simple,Passive,Nothing,Just "not")
...
ex11 = ( "It's done.", (Present,Simple,Passive,Nothing,Nothing)
...
ex12 = ( "It's rarely noted.", (Present,Simple,Passive,Nothing,Nothing)
...
ex13 = ( "I have been watching TV.", (Present,PerfectProgressive,Active,Nothing,Nothing)
...
ex14 = ( "The book had not been noticed.", (Past,Perfect,Passive,Nothing,Just "not")
...
ex15 = ( "I have done the job.", (Present,Perfect,Active,Nothing,Nothing)
...
ex16 = ( "I haven't done the job.", (Present,Perfect,Active,Nothing,Just "not")
...
ex17 = ( "I had done the job at that time.", (Past,Perfect,Active,Nothing,Nothing)
...
ex18 = ( "WhatsApp is being targeted by China's censors.", (Present,Progressive,Passive,Nothing,Nothing)
...
ex19 = ( "WhatsApp have been being targeted by China's censors.", (Present,PerfectProgressive,Passive,Nothing,Nothing)
...
ex20 = ( "WhatsApp should not have been being targeted by China's censors.", (Present,PerfectProgressive,Passive,Just "should",Just "not")
...
ex21 = ( "I looked at the tree.", (Past,Simple,Active,Nothing,Nothing)
...
ex22 = ( "He's actively considering a breakup of giant Wall Street banks.", (Present,Progressive,Active,Nothing,Nothing)
...
checkVP :: (Text,(Tense,Aspect,Voice,Maybe Text,Maybe Text),[(Int,(Lemma,Text))],PennTree,Dependency) -> Bool
checkVP (_txt,expresult,lmatknlst,pt,_dep) =
  let vps = mkVPS lmatknlst pt
  in case vps of
       vp:[] -> expresult == (vp^.vp_tense,vp^.vp_aspect,vp^.vp_voice,vp^?vp_auxiliary._Just._2.to unLemma,vp^?vp_negation._Just._2.to unLemma)
       _ -> False 
