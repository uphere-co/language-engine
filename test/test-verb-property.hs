...
ex4 = ( "The move had been widely expected.", (Past,Perfect,Passive,Nothing)
...
ex5 = ( "I am floating.", (Present,Progressive,Active,Nothing)
...
ex6 = ( "I am studying with Maria.", (Present,Progressive,Active,Nothing)
...
ex7 = ( "We eat lunch.", (Present,Simple,Active,Nothing)
...
ex8 = ( "We are eating lunch.", (Present,Progressive,Active,Nothing)
...
ex9 = ( "We are not eating lunch right now.", (Present,Progressive,Active,Nothing)
...
ex10 = ( "It's not done yet.", (Present,Simple,Passive,Nothing)
...
ex11 = ( "It's done.", (Present,Simple,Passive,Nothing)
...
ex12 = ( "It's rarely noted.", (Present,Simple,Passive,Nothing)
...
ex13 = ( "I have been watching TV.", (Present,PerfectProgressive,Active,Nothing)
...
ex14 = ( "The book had not been noticed.", (Past,Perfect,Passive,Nothing)
...
ex15 = ( "I have done the job.", (Present,Perfect,Active,Nothing)
...
ex16 = ( "I haven't done the job.", (Present,Perfect,Active,Nothing)
...
ex17 = ( "I had done the job at that time.", (Past,Perfect,Active,Nothing)
...
ex18 = ( "WhatsApp is being targeted by China's censors.", (Present,Progressive,Passive,Nothing)
...
ex19 = ( "WhatsApp have been being targeted by China's censors.", (Present,PerfectProgressive,Passive,Nothing)
...
ex20 = ( "WhatsApp should not have been being targeted by China's censors.", (Present,PerfectProgressive,Passive,Just "should")
...
ex21 = ( "I looked at the tree.", (Past,Simple,Active,Nothing)
...
ex22 = ( "He's actively considering a breakup of giant Wall Street banks.", (Present,Progressive,Active,Nothing)
...
ex23 = ( "A major federal civil rights law does not protect employees from discrimination.",(Present,Simple,Active,Nothing)
...
testcases :: [(Text,(Tense,Aspect,Voice,Maybe Text),[(Int,(Lemma,Text))],PennTree,Dependency)]
...
checkVP :: (Text,(Tense,Aspect,Voice,Maybe Text),[(Int,(Lemma,Text))],PennTree,Dependency) -> Bool
checkVP (_txt,expresult,lmatknlst,pt,_dep) =
  let vps = mkVPS lmatknlst pt
  in case vps of
       vp:[] -> expresult == (vp^.vp_tense,vp^.vp_aspect,vp^.vp_voice,vp^?vp_auxiliary._Just._2.to unLemma)
       _ -> False 
