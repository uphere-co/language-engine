...
, scientific, split, stdenv, syntactic-analysis, taggy-lens, text
...
mkDerivation {
  ...
  libraryHaskellDepends = [
    ...
    scientific syntactic-analysis taggy-lens text textview time
  ...
  executableHaskellDepends = [
    ...
    nlp-types optparse-applicative PropBank split syntactic-analysis
